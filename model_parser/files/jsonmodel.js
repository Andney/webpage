    ...
    var k = "",
        ...
        z = function (a, d) {
            ...
            if (q(a)) {
                ...
                var h = p(e),
                    g = B(e);
                q(b) ? (0 < b.length && (f = b[0]), "string" === typeof f ? c += "    private String " + g + ";\r\n" : "number" === typeof f || "boolean" === typeof f ? c += "    private int " + g + ";\r\n" : "object" === typeof f && (h += "Item", c += "    private List<" + h + "> " + g + ";\r\n", b = F(h) + z(b, e) + "}\r\n", m = 0 < m.length ? m + "\r\n" + b : b)) : r(b) ? (b = F(p(g)) + z(b, e) + "}\r\n", m = 0 < m.length ? m + "\r\n" + b : b) : "string" === typeof b ? c += "    private String " + g + ";\r\n" : "number" === typeof b ? c = 0 <= b.toString().indexOf(".") ? c + ("    private double " + g + ";\r\n") : c + ("    private int " + g + ";\r\n") : "boolean" === typeof b && (c += "    private boolean " + g + ";\r\n")
            } else alert("key = " + d);
            return c
        };
    return {
